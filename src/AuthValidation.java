public enum AuthValidation {
    ...
    DATE("[  yyyy.MM.dd  ] : ", "\\d{4}\\.\\d{2}\\.\\d{2}", AnsiColor.red("\t\t\t\t\t\t날짜 형식에 맞게 입력해주세요."), "날짜 입력이 취소되었습니다."),
    EQUIPMENT_COUNT("S갯수/M갯수/L갯수 ex) 1/0/0 : ", "\\d/\\d/\\d", AnsiColor.red("장비 갯수 형식에 맞게 입력해주세요."), AnsiColor.red("장비 갯수 입력이 취소되었습니다.")),
